...
const Contact = () => {
  return (
    <div name='contact' className='w-full h-screen bg-[#1B4242] flex justify-center items-center p-4'>
      <form method='POST' action='https://getform.io/f/17723c4e-4852-480f-be5d-1439bef2c83e' className='flex flex-col max-w-[600px] w-full'>
        ...
        <button className='text-white border-2 hover:bg-[#9EC8B9] hover:text-[#354649]  px-4 py-3 my-8 mx-auto flex items-center'> Let's Connect!</button>
      </form>
    </div>
  )
}
