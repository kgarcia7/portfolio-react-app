...
const Skills = () => {
  return (
    <div name="skills" className="w-full h-screen bg-[#A7D7C5]">
      {/* Container */}
      <div className="max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full">
        <div>
          <p className="text-4xl font-bold inline border-b-4 border-white text-[#5C8D89]">
            Skills
          </p>
        ...
        <div className="w-full grid grid-cols-2 sm:grid-cols-4 gap-4 text-center py-8">
          <div className="shadow-md shadow-[#5C8D89] hover:scale-110 duration-300">
